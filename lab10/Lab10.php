...
function getImages(){
    global $conn;
    $sql = "SELECT Title,Path,ImageID,Description,ContinentCode,CountryCodeISO FROM imagedetails";
		...
		<ul class="caption-style-2">
            ...
            $result = getImages();
             while ($images = $result->fetch_assoc()) {
                 $href = "detail.php?id=" . $images["ImageID"];
                 $src = "images/square-medium/" . $images["Path"];
                 $alt = $images["Title"];
