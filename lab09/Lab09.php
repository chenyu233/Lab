    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              //这里写入小导航栏
                foreach($countries as $key => $value){
                    $href = "Lab09.php?country=".$value;
                    $role = "button";
                    $class = "btn btn-default";
                    $link = '<a href="'.$href.'"   role="'.$role.'"  class="'.$class.'">'.$value.'</a>';
                    echo $link;
              }
            ?>
		...
		<ul class="caption-style-2">
          ...
          //you need to fill the elements with data provided
            ...
            foreach($images as $vlaue){
                $href2 = "detail.php?id=".$vlaue["id"];
                $class2= "img-responsive";
                $imgSrc = "images/square/".$vlaue["path"];
                $imgAlt = $vlaue["title"];
                echo '<li>';
                echo '<a href="'.$href2.'" class="'.$class2.'">';
